...
func NewSqlUserStore(sqlStore SqlStore) UserStore {
	...
	for _, db := range sqlStore.GetAllConns() {
		...
		table.ColMap("IconUrl").SetMaxSize(200)
		table.ColMap("Gender").SetMaxSize(2)
		table.ColMap("IdCard").SetMaxSize(200)
		table.ColMap("Education").SetMaxSize(50)
		table.ColMap("GraduateSchool").SetMaxSize(100)
		table.ColMap("TeachingGrade").SetMaxSize(100)
		table.ColMap("Introduce").SetMaxSize(2000)
		table.ColMap("Interest").SetMaxSize(100)
		table.ColMap("Professional").SetMaxSize(100)
		table.ColMap("ReviewResult").SetMaxSize(20)
